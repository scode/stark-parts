...
core, real HTTP client, and catalog commands exist. The committed catalog data, search model, and usable web UI are not
implemented yet.
...
The catalog commands must be run from the repository root and require network access. From a fresh checkout, run the
